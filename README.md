...
> 借鉴 arayaquant.com《中报业绩预告看板》的五模块方法论,独立实现的**全市场业绩预告高增筛选工具**。
> 全部走东方财富 datacenter 直连,无需付费数据源,可选接入 iFinD 增强行情维度。
...
亮点:
- **全市场一次拉全** — 单次 datacenter 请求覆盖 1000+ 只股(无需分批)
...
dashboard.html   # arayaquant 风格单页看板(Chart.js CDN)
```
...
- 方法论借鉴:arayaquant.com 公开的中报业绩预告看板
- 数据源:东方财富 datacenter (公开 HTTP 接口)
- iFinD:同花顺 iFinD SDK

## License

AGPL-3.0 (与 arayaquant Wyckoff Agent 一致)
